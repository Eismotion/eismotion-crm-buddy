-- Update delete function with correct trigger names
...
BEGIN
  ...
  ALTER TABLE public.invoice_items DISABLE TRIGGER protect_invoice_items_trigger;
  ALTER TABLE public.invoices DISABLE TRIGGER protect_invoices_trigger;
  ...
  ALTER TABLE public.invoice_items ENABLE TRIGGER protect_invoice_items_trigger;
  ALTER TABLE public.invoices ENABLE TRIGGER protect_invoices_trigger;
