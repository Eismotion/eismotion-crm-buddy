import { Package, LayoutDashboard, Users, FileText, ShoppingBag, BarChart3, Settings } from 'lucide-react';
    ...
    <aside className="w-64 bg-sidebar border-r border-sidebar-border flex flex-col">
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-sidebar-foreground">Eismotion</h1>
